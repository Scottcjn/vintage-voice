#!/bin/bash
# =============================================================================
# CosyVoice2-0.5B  --  Irish French LLM finetune  (single 8GB GPU)
# =============================================================================
# Trains ONLY the `llm` model (not flow / hifigan) on the prepared Irish data.
...
#
# Generated for the vintage-voice Irish finetune. DO NOT auto-run blindly --
...
DATA=/home/scott/vintage-voice/data/cosyvoice_irish
...
# --- Train (llm only) --------------------------------------------------------
# conf is run relative to the irish data dir so conf/cosyvoice2_8gb.yaml resolves.
cd ${DATA}
...
${PY} ${REPO}/cosyvoice/bin/train.py \
  ...
  --model_dir /home/scott/vintage-voice/exp/irish/llm \
  --tensorboard_dir /home/scott/vintage-voice/exp/irish/llm/tensorboard \
