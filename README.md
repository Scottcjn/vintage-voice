...
Watch the model in action: **[Sophia Speaks in 1940s Transatlantic](https://bottube.ai/watch/So3ZqYjNt8D)** on BoTTube.

This demo pairs VintageVoice's transatlantic audio output with lip-sync via
LTX-2 19B (multimodalart's `ltx2-audio-to-video` pipeline on Hugging Face).
The voice is generated by this model; the video shows the mouth moving in
